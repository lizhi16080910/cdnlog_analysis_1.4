 ...
 *  5分钟流量统计
 */
object HekaCdnlogFiveMinuteFlowSize_other {

  def main(args: Array[String]) {

    if (args.length != 6) {
      System.err.println("Usage: HekaCdnlogFiveMinuteFlowSize_other <zkQuorum> <group> <topics> <esNode> <maxRate> <uiPort>")
      System.exit(1)
    }
    ...
    val conf = new SparkConf()
      .setAppName("HekaCdnlogFiveMinuteFlowSize_other")
