...
object HekaCdnlogAnalysis_c01i05 extends Logging {
    def main(args: Array[String]) {
        if (args.length != 5) {
            System.err.println("Usage: HekaCdnlogAnalysis_c01i05 <zkQuorum> <group> <topics> <maxRate> <uiPort>")
            System.exit(1)
        }
        ...
        val sparkConf = new SparkConf()
            .setAppName("HekaCdnlogAnalysis_c01i05")
